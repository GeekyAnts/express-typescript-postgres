...
export class CommonService {
    ...
    public async getRows(sql: string, params?: Array<any>) {
        ...
        try {
            ...
            if (result.rowCount === 0) throw 'No data found'
    ...
    public async insertRow(columns: string, param_ids: string, params: Array<any>) {
        ...
        try {
            ...
            if (result.rowCount === 0) throw 'No data inserted'
    ...
    public async insertRows(columns: string, param_ids: string, params: Array<any>, onconflict: string = '') {
        const pool = Helper.pool()
        let result: any

...
export class AuthController {
	...
	public static async whoami(req: CUserAuthInfoRequest, res: Response, _next: NextFunction) {
		if (!req.cUser) {
			return res.json({ success: false, data: { message: 'No user found' } })
		}
	...
	public static async refreshToken(req: CUserAuthInfoRequest, res: Response, _next: NextFunction) {
		if (!req.cUser) {
			return res.json({ success: false, data: { message: 'No user found' } })
		}
